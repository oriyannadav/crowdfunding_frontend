async function getPledges() {
    ...
    if (!response.ok) {
        ...
        // If that is the case then you can change the code below to use a different property, e.g.: `message`

        const errorMessage = data?.detail || fallbackError;
        throw new Error(errorMessage);
    }
    // ...on the other hand, if the request was successful then we will retur n he data from the response.
